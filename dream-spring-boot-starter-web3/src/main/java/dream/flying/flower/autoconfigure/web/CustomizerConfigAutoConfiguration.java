...
import dream.flying.flower.autoconfigure.web.CustomizerConfigAutoConfiguration.CustomizerConfigurationImportSelector;
	...
	static class CustomizerConfigurationImportSelector implements ImportSelector {
		...
		public String[] selectImports(AnnotationMetadata importingClassMetadata) {
			...
			classPathScanningCandidateComponentProvider
					.findCandidateComponents("dream.flying.flower.autoconfigure.web.config")
