...
@ConditionalOnProperty(prefix = ConstConfig.Auto.EMAIL, name = ConstConfig.ENABLED_ENDPOINT, havingValue = "true",
		matchIfMissing = true)
public class EmailRecipientEndpoint
		extends AbstractController<EmailRecipientEntity, EmailRecipientVO, EmailRecipientQuery, EmailRecipientService> {

	@Operation(summary = "查询", description = "分页或不分页查询", method = "GET")
	@Override
	public Result<List<EmailRecipientVO>> list(EmailRecipientQuery query) {
