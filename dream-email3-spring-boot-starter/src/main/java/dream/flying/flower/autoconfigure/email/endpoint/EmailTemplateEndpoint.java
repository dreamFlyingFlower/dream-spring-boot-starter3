...
public class EmailTemplateEndpoint
		extends AbstractController<EmailTemplateEntity, EmailTemplateVO, EmailTemplateQuery, EmailTemplateService> {

	@Operation(summary = "查询", description = "分页或不分页查询", method = "GET")
	@Override
	public Result<List<EmailTemplateVO>> list(EmailTemplateQuery query) {
